      ...
      < form className="p-4 md:p-5">
        <div className="mb-4 grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            ...
            <textarea id="description"  className="mb-2 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" ></textarea>
