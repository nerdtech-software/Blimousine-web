    ...
    return (
        <div style={{ position: 'relative', width: '100%', height: '100vh' }}>
            ...
            <div className="relative z-10 flex items-center justify-start h-full p-7">
                ...
                <button className="text-white bg-Fire hover:bg-Fire-500 focus:ring-4 focus:ring-Fire-300 font-medium rounded-lg text-sm px-10 py-2.5 mt-4 dark:bg-Fire-600 dark:hover:bg-red-900 focus:outline-none dark:focus:ring-red-800">
                        Call Me
                    </button>
            </div>
            </div>
